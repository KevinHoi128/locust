...
class callCheckQtyAndPlaceOrder(Taskset):
    @task
    def work_flow(self):
    ...
    def get_product_available(self):
        self.client.post("/quantity-service/get-redis-qty", json={'merchant_id': 'as-one', 'product_ids': ['614d8ed9ff6b830006860d04', '5fab9e0d33a439000ae19acd', '61dd25ad41dea4000af7c1fd']})

    def place_order(self):
        self.client.post("/checkout-service/quota-checkout", data=json.dumps({
            "checkout_request": {
                "merchant_id": "as-one",
                "items": [
                    {
